...
public extension UIButton {
     ...
     */
    func setFAIcon(_ icon: FAType, forState state: UIControl.State) {
        FontLoader.loadFontIfNeeded()
     ...
     */
    func setFAIcon(_ icon: FAType, iconSize: CGFloat, forState state: UIControl.State) {
    ...
    func setFATitleColor(_ color: UIColor, forState state: UIControl.State = .normal) {
        FontLoader.loadFontIfNeeded()
...
public extension UIImageView {
     ...
     */
    func setFAIconWithName(_ icon: FAType, textColor: UIColor, backgroundColor: UIColor = UIColor.clear) {
        FontLoader.loadFontIfNeeded()
